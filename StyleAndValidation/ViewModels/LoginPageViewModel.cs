    ...
    public class LoginPageViewModel:ViewModelBase
    {
       readonly AppServices appServices;
        ...
        public LoginPageViewModel(AppServices service)
        {
            ...
            LoginCommand = new Command(async () => {  await AppShell.Current.GoToAsync("Loading"); var loading = AppShell.Current.CurrentPage.BindingContext as LoadingPageViewModel; bool success = await appServices.Login(Username, Password);
